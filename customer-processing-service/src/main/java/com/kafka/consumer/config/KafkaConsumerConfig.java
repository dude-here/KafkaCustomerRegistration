...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, CustomerEvent> consumerFactory() {
		...
		// JsonDeserializer<CustomerEvent> deserializer =
		new JsonDeserializer<>(CustomerEvent.class, false);
		...
		config.put(ConsumerConfig.GROUP_ID_CONFIG, "customer-processing-group");
